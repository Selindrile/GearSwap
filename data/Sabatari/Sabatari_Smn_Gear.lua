...
function character_user_job_setup()
	...
	send_command('bind !` input //gs c siphon')
	
	send_command('bind !numpad1 input /ma Carbuncle <me>')
	send_command('bind !numpad8 input /ma Ifrit <me>')
	send_command('bind !numpad9 input /ma Ramuh <me>')
	send_command('bind !numpad4 input /ma Siren <me>')
	send_command('bind !numpad5 input /ma Garuda <me>')
	send_command('bind !numpad6 input /ma Shiva <me>')
	send_command('bind !numpad7 input /ma Fenrir <me>')
	send_command('bind !numpad2 input /ma Titan <me>')
	send_command('bind !numpad3 input /ma "Diabolos" <me>')
	send_command('bind !numpad0 input /ma Leviathan <me>')
	send_command('bind !numpad. input /ma "Cait sith" <me>')
    send_command('bind !numpadenter input /ja Assault <t>')
    send_command('bind !numpad+ input /ja Retreat <me>')
	send_command('bind numlock input /ja Release <me>')
	send_command('bind !right input /ja Apogee <me>')
...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {		
		body="Con. Doublet +3",
		back={ name="Conveyance Cape", augments={'Summoning magic skill +4','Pet: Enmity+11',}},}
    ...
    sets.precast.FC = {    
		main={ name="Grioavolr", augments={'Blood Pact Dmg.+8','Pet: STR+13','Pet: Mag. Acc.+11','Pet: "Mag.Atk.Bns."+28',}},
		head="C. Palug Crown",
		body="Inyanga Jubbah +2",
		hands={ name="Telchine Gloves", augments={'"Fast Cast"+4','Enh. Mag. eff. dur. +8',}},
    ...
    sets.midcast.Pet.BloodPactWard = {main={ name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}},--15
		sub="Vox Grip",--3
		head="Beckoner's Horn +2",--13
		hands="Inyan. Dastanas +2",--20
		feet="Baayami Sabots", --24
		neck="Caller's Pendant",--9
		right_ring="Evoker's Ring",--10
		right_ear="Lodurr Earring",--10
		back={ name="Conveyance Cape", augments={'Summoning magic skill +4','Pet: Enmity+11',}},--12
}
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = { 
		...
		head="C. Palug Crown",
		body="Con. Doublet +3",
		hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+23 Pet: "Mag.Atk.Bns."+23','Blood Pact Dmg.+7','Pet: INT+5','Pet: "Mag.Atk.Bns."+15',}},
		legs="Apogee Slacks +1",
		feet={ name="Helios Boots", augments={'Pet: Accuracy+30 Pet: Rng. Acc.+30','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+6',}},
    ...
    sets.idle.Avatar = {
		main={ name="Gridarvor", augments={'Pet: Accuracy+70','Pet: Attack+70','Pet: "Dbl. Atk."+15',}}, -- -5 perp
		sub="Enki Strap",
		head="Beckoner's Horn +2", -- +2 refresh
		body={ name="Apo. Dalmatica +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}, -- +4 refresh
		hands="Asteria Mitts +1", -- +2 refresh
		legs="Assid. Pants +1", -- +2 refresh
		feet="Baayami Sabots", -- +2 refresh
		neck="Caller's Pendant",
		waist="Lucidity Sash", -- -2 perp
		left_ear="Evans Earring", -- -2 perp
		right_ear="Beck. Earring +1", -- +2 refresh
		left_ring="Defending Ring",
		right_ring="Evoker's Ring", -- -1 perp
