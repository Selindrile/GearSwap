...
function user_setup()
  ...
  update_combat_form()
	...
	gear.Smertrios_STP = {name="Smertrios's Mantle",augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10',}}
...
function init_gear_sets()
  ...
  --------------------------------------
  gear.Smertrios_WSD = { name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
  gear.Smertrios_DA = { name="Smertrios's Mantle", augments={'Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10',}}
  gear.Smertrios_STP = gear.Smertrios_DA
  ...
  sets.idle.Weak =  set_combine(sets.Reraise,{
    ammo="Staunch Tathlum +1",
    neck="Loricate Torque +1",
  ...
  sets.engaged.DTLite = set_combine(sets.engaged.PDT,{})
  sets.engaged.SomeAcc.DTLite = set_combine(sets.engaged.PDT,{})
  sets.engaged.Acc.DTLite = set_combine(sets.engaged.PDT,{})
  sets.engaged.FullAcc.DTLite = set_combine(sets.engaged.PDT,{})
  sets.engaged.Fodder.DTLite = set_combine(sets.engaged.PDT,{})
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    back=gear.Smertrios_STP,waist="Ioskeha Belt",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
  sets.engaged.Adoulin.SomeAcc = {ammo="Ginsen",
    ...
    back=gear.Smertrios_STP,waist="Windbuffet Belt +1",legs="Wakido Haidate +3",feet="Amm Greaves"}
    ...
    body="Kasuga Domaru +1",hands="Flam. Manopolas +2",ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
    back=gear.Smertrios_STP,waist="Olseni Belt",legs="Wakido Haidate +3",feet="Amm Greaves"}
  sets.engaged.Adoulin.FullAcc = {ammo="Ginsen",
    ...
    back=gear.Smertrios_STP,waist="Olseni Belt",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
  sets.engaged.Adoulin.Fodder = {ammo="Ginsen",
    ...
    body="Kasuga Domaru +1",hands="Flam. Manopolas +2",ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
    back=gear.Smertrios_STP,waist="Windbuffet Belt +1",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
  ...
  sets.weapons.ProcWeapon = {main="Norifusa",sub="Alber Strap"}
  sets.weapons.Bow = {
    main="Norifusa",
    sub="Utu Grip",
    --range="Cibitshavore",
  ...
  -- Buff sets
  sets.Cure_Received = {waist="Gishdubar Sash",legs="Flamma Dirs +2"}--hands="Buremte Gloves",
