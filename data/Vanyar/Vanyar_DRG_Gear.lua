...
function init_gear_sets()
	...
	sets.precast.JA.Jump = {--STP ?
    ammo="Ginsen",
		head="Flam. Zucchetto +2",
    neck="Ganesha's Mala",
    ear1="Brutal Earring",
    ear2="Sherida Earring",
		body=gear.Val_Body_STP,
	...
	sets.precast.WS = { --stardriver etc
    ammo="Knobkierrie",
		head="Flam. Zucchetto +2",
    neck="Fotia Gorget",
    ...
    ring1="Regal Ring",
    ring2="Niqmaddu Ring",
		back="Brigantia's Mantle",--STR +30, Acc/Atk +20, DA +10
    waist="Fotia Belt",
    legs="Sulev. Cuisses +2",
    feet="Flam. Gambieras +2",
  }
  ...
  sets.passive.Twilight = {head="Twilight Helm", body="Twilight Mail"}
    ...
    waist="Ioskeha Belt +1",
    legs="Sulev. Cuisses +2",
    --legs="Valor. Hose",--STR +7~10, Acc/Atk +15+, STP +7~8
    feet="Flam. Gambieras +2",
  }
